...
void Tema1::OnInputUpdate(float deltaTime, int mods)
{
    ...
    if (window->KeyHold(GLFW_KEY_A)) {
        if (positionBackgroundX < 590 && ((positionBackgroundX < 168) ||  positionBackgroundX > 445 || ((positionBackgroundY > 190 || positionBackgroundY < -284 )))
                                      && ((positionBackgroundX < 65) || positionBackgroundX > 250 || ((positionBackgroundY > -145 || positionBackgroundY < -425)))
                                      && ((positionBackgroundX < -525) || positionBackgroundX > -320 || ((positionBackgroundY > 130 || positionBackgroundY < -55)))
                                      && ((positionBackgroundX < -850) || positionBackgroundX > -530 || ((positionBackgroundY > -65 || positionBackgroundY < -240)))
                                      && ((positionBackgroundX < -1270) || positionBackgroundX > -866 || ((positionBackgroundY > -581 || positionBackgroundY < -962))) /**/
                                      && ((positionBackgroundX < -1280) || positionBackgroundX > -1075 || ((positionBackgroundY > -1045 || positionBackgroundY < -1330)))/**/
                                      && ((positionBackgroundX < -675) || positionBackgroundX > -370 || ((positionBackgroundY > -780 || positionBackgroundY < -1060)))/**/
                                      && ((positionBackgroundX < -640) || positionBackgroundX > -235 || ((positionBackgroundY > -890 || positionBackgroundY < -1369)))
                                      && ((positionBackgroundX < -340) || positionBackgroundX > 62 || ((positionBackgroundY > -1500 || positionBackgroundY < -1600)))
                                      && ((positionBackgroundX < 318) || positionBackgroundX > 418 || ((positionBackgroundY > -770 || positionBackgroundY < -1250)))) {
